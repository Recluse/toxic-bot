...
_COOLDOWN_QUIPS = [
    ...
    "Не части. Минута паузы — авось за это время до тебя что-нибудь да дойдёт.",
    "Куда гонишь? Один вопрос в минуту. Дай мне насладиться тишиной от тебя.",
    "Лимит — один вопрос в минуту. Слишком много чести — дёргать меня чаще.",
...
_VISION_DESCRIBE_PROMPT = (
    ...
    "текст, приведи его дословно. Кириллический текст приводи РОВНО кириллицей — "
    "не транслитерируй его в латиницу (например, надпись «ВАКУУМ» — это «ВАКУУМ», "
    "а не «BAKYUM»). Только нейтральное описание, без оценок, "
