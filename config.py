...
class AppConfig:
    telegram_token: str
    superadmin_ids: frozenset  # frozenset[int] — superadmin Telegram user IDs
    bot: BotConfig
...
def _parse_superadmin_ids() -> frozenset:
    ...
    Returns empty frozenset if not set — bot will work but superadmin
