...
_COMMANDS_PUBLIC = {
    "en": [
        ...
        {"command": "dont_touch_me", "description": "Groups: add yourself to ignore list (except /explain)"},
    ...
    "ru": [
        ...
        {"command": "dont_touch_me", "description": "Группы: добавить себя в игнор бота (кроме /explain)"},
    ...
    "uk": [
        ...
        {"command": "dont_touch_me", "description": "Групи: додати себе в ігнор бота (крім /explain)"},
